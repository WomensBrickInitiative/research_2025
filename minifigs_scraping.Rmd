...
categories_subset8 <- categories_data[251:300,]  ## STOPPED HERE
...
categories_subset9 <- categories_data[301:325,]
data_sub8 <- purrr::map2(categories_subset9$link, categories_subset9$category, scrape_minifigs_data) 
data_bind_s9 <- plyr::ldply(data_sub9, rbind)

map_int(data_sub8, nrow)
...
map_int(data_sub8, nrow) ## CHECK TO SEE THAT THERE ARE NO ZEROS HERE
