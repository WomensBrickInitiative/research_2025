...
- Create a new google sheet and make sure the share setting is "anyone with the link". 
...
- When you format the flowchart in WordPress, you will link to this sheet you just created so that if the users want to go beyond the numbers they see in the chart and see the actual options, it is super easy. 
