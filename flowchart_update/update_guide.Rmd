...
Before starting, make sure you have R and Studio installed. In order to run the code in this document, you will need to open the .Rmd version (update_guide.Rmd) in R Studio. If you are new to R, here are some helpful links to get you started:
