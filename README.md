...
We conducted an analysis on gender equity and flesh tone diversity in minifig heads, wigs, and torsos available and how this has changed over time from 2015-2022. For heads, we found that flesh tone diversity has improved somewhat but not much, yet gender diversity has improved significantly such that the percentages of male, female, and neutral heads are almost exactly equal in 2022. For wigs, we found that the number of wigs was fairly gender-equitable, yet female wigs were surprisingly more expensive than male wigs. For torsos, we found that the majority of torsos are neutral and used for both genders, while very few are explicitly male.
...
- Is LEGO Putting a Price on Diversity? An exploration of LUGBULK, where cheap LEGOs are bought in bulk (Part 3: Minifig Torsos)
