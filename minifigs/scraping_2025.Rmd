...
summary_total <- summary_total %>% 
  filter(str_detect(Name, "Sienna|Medium Brown|Yellow|Nougat|Tan")) %>% 
...
export_table(summary_final, format = "html")
```
...
update_heads <- color_skin_sum_wide %>% 
  ...
  labs(title = "Distribution of Flesh Tones of Minifigure Heads (2022-2024)",
       x = "Flesh Tones",
       y = "Count") +
